...
Tasks modules are located in the **src** folder. Each module consists of several tasks for specified topic. Each task is usually a regular function:
...
- Find the test corresponding to the function in the opened Test Results page. You can see the `points` associated with the particular test on the webpage.
